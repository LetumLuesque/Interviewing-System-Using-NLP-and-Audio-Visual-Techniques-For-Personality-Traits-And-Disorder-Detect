...
def load_checkpoint(filepath, model, optimizer=None, scheduler=None):
    ...
    elif not strict_load_success:
        print("Model shapes changed. Starting with fresh optimizer state.")
    
    if scheduler and checkpoint.get('scheduler_state_dict') and strict_load_success:
